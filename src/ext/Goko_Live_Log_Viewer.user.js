var _foo = function () {
    ...
    var setsComp = {
        ...
        bishop:"P4",monument:"P4",quarry:"P4",talisman:"P4",workersvillage:"P4",
...
// All put the real content inside _foo. Don't run it until Goko has
// instantiated the FS.Dominion.DeckBuilder object.
var intvl = setInterval(function () {
    if (typeof FS !== 'undefined'
        && typeof FS.Dominion !== 'undefined'
        && typeof FS.Dominion.DeckBuilder !== 'undefined') {
        clearInterval(intvl);
        _foo();
    }
},100);
